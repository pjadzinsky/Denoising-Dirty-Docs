...
model.graph.load_weights('model_weights/m8_epoch100.hdf5')
model.fit(train, cleaned, epochs, save_models=list(range(0,epochs,save_every_epochs)), first_epoch=101)
